...
def clean(data, column_data, Delta, start_value, plateau_number, plot_derivative, plot_slots):
    ...
    if plot_slots == True:
        ...
        plt.savefig(f'FilteredData{column_data}.png', dpi=600, bbox_inches = 'tight')
